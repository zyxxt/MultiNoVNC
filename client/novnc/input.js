...
function captureMouse() {
    ...
    mouseCaptured = true;
Util.Warn('mouseCaptured:' + mouseCaptured);
}
...
//    Util.Warn("mouse " + pos.x + "," + pos.y + " down: " + down +
//               " bmask: " + bmask + "(evt.button: " + evt.button + ")");
...
//    Util.Warn('mouse scroll by ' + wheelData + ':' + pos.x + "," + pos.y);
    if (conf.onMouseButton) {
...
//        Util.Warn("mouse event disabled");
			Util.stopEvent(e);
			return false;
		}
	}
    Util.Debug("mouse event not disabled");
//    Util.Warn("mouse event not disabled");
    return true;
}
