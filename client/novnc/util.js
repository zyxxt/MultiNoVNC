...
Util.getScrollPosition = function (obj) {
	var x = 0, y = 0;
	if (obj.parentNode) {
		do {
			x += obj.scrollLeft;
...
Util.getEventPosition = function (e, obj, scale) {
    var evt, docX, docY, pos, scrollPos;
    ...
    if (evt.pageX || evt.pageY) {
        docX = evt.pageX;
        docY = evt.pageY;
	Util.Info('pageX:' + evt.pageX + ',pageY:' + evt.pageY);
	...
	Util.Info('clientx:' + evt.clientX + ',clienty:' + evt.clientY + ',docbdleft:' + document.body.scrollLeft + ',docdeleft' + document.documentElement.scrollLeft
		+ ',docbdtp:' + document.body.scrollTop + ',docdetp:' + document.documentElement.scrollTop + ',dx:' + obj.x + ',dy:' + obj.y);
    pos = Util.getPosition(obj);
	scrollPos = Util.getScrollPosition(obj);
    if (typeof scale === "undefined") {
        scale = 1;
    }
    var realx = docX - pos.x + scrollPos.x ;
    var realy = docY - pos.y + scrollPos.y;
	Util.Info('mouse docX:' + docX + ',docY:' + docY + ',pos.x' + pos.x + ',pos.y' + pos.y);
